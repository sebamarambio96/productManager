...
import { productManager } from "../../controllers/productsControllerFs.js";

export class CartManager {
    constructor(path, products) {
        (this.path = path), (this.products = products);
    }
    async getCarts() {
    ...
    async addCart() {
        ...
        arrayCarts.push(newCart) | (await this.saveCarts(arrayCarts));
    }
